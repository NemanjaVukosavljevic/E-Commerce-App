  ...
  return (
    <nav className="bg-gray-800 p-4">
      <div className="container mx-auto flex justify-between items-center">
        <Link to="/" className="text-white text-lg font-bold">My Ecommerce</Link>
        <div className="flex items-center">
          <Link to="/cart" className="relative text-white mr-6">
            ...
            {cartItemCount > 0 && <span className="absolute top-0 right-0 bg-red-500 rounded-full text-white px-2">{cartItemCount}</span>}
          </Link>
        </div>
      </div>
    </nav>
